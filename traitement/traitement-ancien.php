<?php include("../header.php");?>
         ...
         <div id="panneau">
            <ul>
               <li class="actif"><a href="traitement-ancien.php">Ancienne commande</a></li>
               <li><a href="traitement-mois.php">Recapitulatif mensuel</a></li>
            </ul>
         </div>
         <div id="texte">
  ...
  if ($_POST['listeCommande'] != "Vide")
  {
    ...
    try
    {
      ...
      while ($strContenirCommande=$objContenirCommande->fetch())
      {
        ...
        echo '<td class="recapitulatif">' . number_format($strContenirCommande['PrixDuJour'], 2).' €</td>';
        echo '<td class="recapitulatif">' . number_format($strContenirCommande['Total'], 2) . ' €</td>';
        echo '</tr>';
      }
      ...
      echo '<td class="centrer">' . number_format($strPrixCommande['TotalCommande'], 2) . ' €</td>';
      echo '</tr></tbody></table>';
    }
    catch(Exception $e)
    {
