<?php include("../header.php");?>
         ...
         <div id="panneau">
            <ul>
               <li><a href="http://localhost:8888/AuMarcheCouvert/traitement/traitement-ancien.php">Ancienne commande</a></li>
               <li class="actif"><a href="http://localhost:8888/AuMarcheCouvert/traitement/traitement-mois.php">Recapitulatif mensuel</a></li>
            </ul>
         </div>
         <div id="texte">
