<?php include("../header.php");?>
         ...
         <div id="panneau">
            <ul>
               <li><a href="traitement-ancien.php">Ancienne commande</a></li>
               <li class="actif"><a href="traitement-mois.php">Recapitulatif mensuel</a></li>
            </ul>
         </div>
         <div id="texte">
...
if (isset($_POST['listeRestaurants']))
{
  ...
  {
    echo '<h3><strong>'.htmlspecialchars($_POST['listeRestaurants']).'</strong></h3>';
    ...
    try
    {
      ...
      while ($strCommandeDuRestaurant=$objCommandeDuRestaurant->fetch())
      {
        ...
        echo '<td class="recapitulatif">' . number_format($strCommandeDuRestaurant['TotalCom'], 2) . ' €</td>';
        echo '</tr>';
      }
    ...
    try
    {
      ...
      echo '<td class="centrer">' . number_format($strTotalCommandeMois['TotalComMois'], 2) . ' €</td>';
      echo '</tr>';
      echo '</tbody></table>';
    }
    catch(Exception $e)
